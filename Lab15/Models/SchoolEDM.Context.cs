...
namespace Lab15.Models
{
    ...
    public partial class SchoolEntities : DbContext
    {
        ...
        public virtual ObjectResult<BuscarAñoContratoPerson_Result> BuscarAñoContratoPerson(string hireDate)
        {
            var hireDateParameter = hireDate != null ?
                new ObjectParameter("HireDate", hireDate) :
                new ObjectParameter("HireDate", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BuscarAñoContratoPerson_Result>("BuscarAñoContratoPerson", hireDateParameter);
        }
    
        public virtual ObjectResult<BuscarCodigoPerson_Result> BuscarCodigoPerson(string personID)
        {
            var personIDParameter = personID != null ?
                new ObjectParameter("PersonID", personID) :
                new ObjectParameter("PersonID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BuscarCodigoPerson_Result>("BuscarCodigoPerson", personIDParameter);
        }
    
        public virtual ObjectResult<BuscarCursoNombre_Result> BuscarCursoNombre(string name)
        {
            var nameParameter = name != null ?
                new ObjectParameter("Name", name) :
                new ObjectParameter("Name", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BuscarCursoNombre_Result>("BuscarCursoNombre", nameParameter);
        }
    
        public virtual ObjectResult<BuscarCursoTitulo_Result> BuscarCursoTitulo(string titulo)
        {
            var tituloParameter = titulo != null ?
                new ObjectParameter("Titulo", titulo) :
                new ObjectParameter("Titulo", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BuscarCursoTitulo_Result>("BuscarCursoTitulo", tituloParameter);
        }
